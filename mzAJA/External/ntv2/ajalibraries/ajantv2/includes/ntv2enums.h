...
#define AJA_NTV2_SDK_BUILD_NUMBER		6			///< @brief The SDK build number, an unsigned decimal integer.
#define AJA_NTV2_SDK_BUILD_DATETIME		"Thu Apr 06 19:54:21 UTC 2023"		///< @brief The date and time the SDK was built, in this format: "MM/DD/YYYY +8:hh:mm:ss"
